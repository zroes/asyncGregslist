  ...
  static DynamicCarForm(car = {}) {
    ...
    <form onsubmit="app.carsController.${car.id ? `updateCar('${car.id}')` : 'createCar()'}" class="row p-4">
      ...
      <div class="mb-2 col-4">
        ...
        <input type="number" name="year" id="year" class="form-control" required min="0" max="3000"
          value="${car.year || 2023}">
      </div>
      ...
      <div class="text-end mt-2">
        <button class="btn" data-bs-toggle="modal" data-bs-target="#create-modal" type="button">cancel</button>
